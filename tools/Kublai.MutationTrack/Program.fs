module Kublai.MutationTrack.Program
...
let private defaultOptionsForSpike () =
    { TestProject = "tests/Kublai.Mutation.Tests/Kublai.Mutation.Tests.fsproj"
      ProjectUnderTest = "src/Kublai.Domain/Kublai.Domain.fsproj"
      MutateScope = "src/Kublai.Domain/Library.fs"
      MutationLevel = "Basic"
      Concurrency = 1
      OutputPath = "artifacts/mutation/mut01-domain"
      LogPath = "/tmp/kublai-mutation-fsharp-spike.log"
...
let private defaultOptionsForFsharpCompileValidation () =
    { ProjectPath = "src/Kublai.Domain/Kublai.Domain.fsproj"
      SourceFilePath = "src/Kublai.Domain/Library.fs"
      MaxMutants = 9
...
let private defaultOptionsForFsharpNativeRuntime () =
    { SourceFilePath = "src/Kublai.Domain/Library.fs"
      TestProjectPath = "tests/Kublai.Mutation.Tests/Kublai.Mutation.Tests.fsproj"
      MaxMutants = 12
...
let private runClassifyFailure (arguments: Map<string, string>) =
    let logPath =
        ...
        |> Option.defaultValue "/tmp/kublai-mutation-fsharp-spike.log"
        ...
        | "run" ->
            let options =
                { defaultOptionsForSpike () with
                    ...
                    LogPath = "/tmp/kublai-mutation-track.log"
