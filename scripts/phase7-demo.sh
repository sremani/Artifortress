...
oidc_audience="${OIDC_AUDIENCE:-kublai-api}"
oidc_shared_secret="${OIDC_SHARED_SECRET:-phase7-demo-oidc-secret}"
oidc_jwks_url="${OIDC_JWKS_URL:-}"
oidc_jwks_refresh_interval_seconds="${OIDC_JWKS_REFRESH_INTERVAL_SECONDS:-300}"
oidc_jwks_refresh_timeout_seconds="${OIDC_JWKS_REFRESH_TIMEOUT_SECONDS:-10}"
...
Auth__Oidc__JwksUrl="$oidc_jwks_url" \
Auth__Oidc__JwksRefreshIntervalSeconds="$oidc_jwks_refresh_interval_seconds" \
Auth__Oidc__JwksRefreshTimeoutSeconds="$oidc_jwks_refresh_timeout_seconds" \
